...
export const AI_TEAM: Debater[] = [
  { id: 'a1', name: '锐言', role: SpeakerRole.FIRST, isAI: true, avatar: 'https://picsum.photos/seed/a1/100/100' },
  { id: 'a2', name: '澈言', role: SpeakerRole.SECOND, isAI: true, avatar: 'https://picsum.photos/seed/a2/100/100' },
  { id: 'a3', name: '砺言', role: SpeakerRole.THIRD, isAI: true, avatar: 'https://picsum.photos/seed/a3/100/100' },
];
